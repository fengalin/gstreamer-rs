...
//#[cfg(feature = "v1_8")]
//pub fn info_vasprintf(result: /*Unimplemented*/String, format: &str, args: /*Unknown conversion*//*Unimplemented*/Unsupported) -> i32 {
//    unsafe { TODO: call ffi::gst_info_vasprintf() }
//}

//pub fn init<P: Into<Option<i32>>>(argc: P, argv: /*Unimplemented*/Vec<String>) {
//    unsafe { TODO: call ffi::gst_init() }
//}

//pub fn init_check<P: Into<Option<i32>>>(argc: P, argv: /*Unimplemented*/Vec<String>) -> Result<(), Error> {
