...
impl<O: IsA<Clock> + IsA<glib::object::Object>> ClockExt for O {
    ...
    fn set_master<'a, P: IsA<Clock> + 'a, Q: Into<Option<&'a P>>>(&self, master: Q) -> Result<(), glib::error::BoolError> {
        ...
        unsafe {
            glib::error::BoolError::from_glib(ffi::gst_clock_set_master(self.to_glib_none().0, master.0), "gst_clock_set_master")
        }
    }
    ...
    fn wait_for_sync(&self, timeout: ClockTime) -> Result<(), glib::error::BoolError> {
        unsafe {
            glib::error::BoolError::from_glib(ffi::gst_clock_wait_for_sync(self.to_glib_none().0, timeout), "gst_clock_wait_for_sync")
        }
    }
